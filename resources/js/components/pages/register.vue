<template>
    <div class="container mt-5 row justify-content-md-center">
        ...
        <div class="input-group mb-3" ref="website" >
            <span class="input-group-text" style="min-width:100px" >Website</span>
            <input class="form-control" type="text" v-model="website" required autocomplete="website" autofocus>
            <div class="invalid-feedback"/>
        </div>
        ...
        <div class="input-group mb-3" ref="password" >
            ...
            <div class="form-group row mb-0">
                <div class="col-md-8 offset-md-4">
                    <div @click="click" class="btn btn-primary"> register </div>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods : {
            async click( ){
                ...
                try {
                    var form = await this.axios.post( 'api/register' , {
                        name     : this.name     ,
                        email    : this.email    ,

...
var jwt_1 = __webpack_require__(/*! ../Services/jwt */ "./resources/js/Services/jwt.ts");
  ...
  auth.getme = function (api_token) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (api_token) jwt_1["default"].setheadersAuth(api_token);
            if (!jwt_1["default"].checkIfUserExists()) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , axios_1["default"].get('api/me')];
...
var bus_1 = __webpack_require__(/*! ./bus */ "./resources/js/Services/bus.ts");
...
function () {
  ...
  Object.defineProperty(jwt, "user", {
    get: function get() {
      var user = this._user || (this._user = this.getFromlocalStorage());
      return user;
    },
  ...
  jwt.saveInlocalStorage = function (_user) {
    var _a;

    if (_user) localStorage.setItem('user', JSON.stringify(this.user));else localStorage.removeItem('user');
    this.setheadersAuth((_a = this.user) === null || _a === void 0 ? void 0 : _a.token);
  };

  jwt.getFromlocalStorage = function () {
    var user = JSON.parse(localStorage.getItem('user'));
    this.setheadersAuth(user === null || user === void 0 ? void 0 : user.token);
    return user;
  };

  jwt.login = function (user) {
    if (user) {
      this.user = user;
      bus_1["default"].$emit('user_login');
    }
  };
  ...
  jwt.checkIfUserExists = function () {
    return this.user !== null;
  };

  jwt.setheadersAuth = function (token) {
...
/* harmony import */ var _Models_auth_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Models/auth.ts */ "./resources/js/Models/auth.ts");
/* harmony import */ var _Models_auth_ts__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Models_auth_ts__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _Models_auth_ts__WEBPACK_IMPORTED_MODULE_2___default().logout();
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.checkIfUserExists = _Services_jwt_ts__WEBPACK_IMPORTED_MODULE_1__.default.checkIfUserExists();
  ...
  mounted: function mounted() {
    if (this.$router.currentRoute.query.api_token) {
      _Services_jwt_ts__WEBPACK_IMPORTED_MODULE_1__.default.login(_Models_auth_ts__WEBPACK_IMPORTED_MODULE_2___default().getme(this.$router.currentRoute.query.api_token));
      this.$router.push({
        name: 'home'
      });
    }
...
/* harmony import */ var _Services_bus_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Services/bus.ts */ "./resources/js/Services/bus.ts");
...
vue__WEBPACK_IMPORTED_MODULE_5__.default.use((vue_axios__WEBPACK_IMPORTED_MODULE_1___default()), (axios__WEBPACK_IMPORTED_MODULE_2___default()));
vue__WEBPACK_IMPORTED_MODULE_5__.default.use(function (Vue) {
  Vue.prototype.$bus = _Services_bus_ts__WEBPACK_IMPORTED_MODULE_4__.default;
});
var router = new vue_router__WEBPACK_IMPORTED_MODULE_6__.default({
  mode: 'history',
  routes: _routes__WEBPACK_IMPORTED_MODULE_3__.routes
});
var vue = new vue__WEBPACK_IMPORTED_MODULE_5__.default({
  el: '#app',
  router: router,
...
var routes = [{
  ...
  path: '/login',
  component: function component() {
    return __webpack_require__.e(/*! import() */ "resources_js_components_pages_login_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./components/pages/login.vue */ "./resources/js/components/pages/login.vue"));
  }
}, {
  name: 'register',
  path: '/register',
  component: function component() {
    return __webpack_require__.e(/*! import() */ "resources_js_components_pages_register_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./components/pages/register.vue */ "./resources/js/components/pages/register.vue"));
  }
}, {
  name: 'Users',
  path: '/Users',
  component: function component() {
    return __webpack_require__.e(/*! import() */ "resources_js_components_pages_Users_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./components/pages/Users.vue */ "./resources/js/components/pages/Users.vue"));
  }
}];
      ...
      _c(
        ...
        [
          _c(
            ...
            [_vm._v("Laravel - mohmed gad task")]
          ),
          _vm._v(" "),
...
/******/ 			if ({"resources_js_components_pages_home_vue":1,"resources_js_components_pages_login_vue":1,"resources_js_components_pages_register_vue":1,"resources_js_components_pages_Users_vue":1}[chunkId]) return "js/" + chunkId + ".js";
